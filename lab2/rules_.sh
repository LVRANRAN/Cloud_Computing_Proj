...
# http h1-a-b-d-h2
ovs-ofctl add-flow s1 in_port=1,priority=65535,tcp,tcp_dst=80,actions=output:2
ovs-ofctl add-flow s2 in_port=1,priority=65535,tcp,tcp_dst=80,actions=output:2
ovs-ofctl add-flow s4 in_port=1,priority=65535,tcp,tcp_dst=80,actions=output:2
...
# http h2-d-c-a-h1
ovs-ofctl add-flow s4 in_port=2,priority=65535,tcp,tcp_src=80,actions=output:3
ovs-ofctl add-flow s3 in_port=3,priority=65535,tcp,tcp_src=80,actions=output:1
ovs-ofctl add-flow s1 in_port=3,priority=65535,tcp,tcp_src=80,actions=output:1
